...
- `implementation_path`: 3–5 short ordered step names (1–2 words each, may keep original-language terms), shown as `A → B → C`. The high-level path to apply this material.
